...
[![Email](https://img.shields.io/badge/Email-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:ankitwhatsapps@gmail.com)
...
<table>
  <tr>
    <td width="33%" valign="top">
      <h3>🏦 DeFi Banking Gateway</h3>
      <img src="https://img.shields.io/badge/Status-Building-orange?style=flat-square" />
      <img src="https://img.shields.io/badge/Market-USA-blue?style=flat-square" />
      <br/><br/>
      Compliant DeFi-to-bank infrastructure for US consumers. Wallet-to-bank bridging, full KYC/AML pipeline, USD stablecoin transfers, and FinCEN-compliant transaction monitoring.
      <br/><br/>
      <b>Stack:</b> Solidity · Next.js · Ethers.js · Node.js · Plaid API · Circle API · MongoDB · Redis
      <br/><br/>
      <b>Compliance:</b> FinCEN · BSA · OFAC · KYC/AML
    </td>
    <td width="33%" valign="top">
      <h3>🔍 AML Intelligence Engine</h3>
      <img src="https://img.shields.io/badge/Status-Building-orange?style=flat-square" />
      <img src="https://img.shields.io/badge/Market-USA-blue?style=flat-square" />
      <br/><br/>
      Graph Neural Network-powered Anti-Money Laundering for US financial institutions. Reduces false positives by 70%+ vs rule-based systems. SAR auto-drafting, OFAC screening, structuring detection.
      <br/><br/>
      <b>Stack:</b> Python · PyTorch Geometric · Node.js · FastAPI · MongoDB · Next.js
      <br/><br/>
      <b>Compliance:</b> FinCEN SAR/CTR · OFAC SDN Screening
    </td>
    <td width="33%" valign="top">
      <h3>🏙️ Urban Flow API v2</h3>
      <img src="https://img.shields.io/badge/Status-In_Progress-green?style=flat-square" />
      <img src="https://img.shields.io/badge/Market-India-green?style=flat-square" />
      <br/><br/>
      Real-time traffic prediction, EV route optimization, and smart city logistics intelligence. AI APIs for sustainable mobility integrating with Indian Smart Cities Mission infrastructure.
      <br/><br/>
      <b>Stack:</b> Next.js · MongoDB · Firebase · Python · FastAPI · Redis · TensorFlow Lite
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <h3>🏭 ASSAVA Workforce Platform</h3>
      <img src="https://img.shields.io/badge/Status-In_Progress-green?style=flat-square" />
      <img src="https://img.shields.io/badge/Sector-Steel_Industry-gray?style=flat-square" />
      <br/><br/>
      ML job-matching and workforce management for the Indian steel sector. Bipartite matching with hard constraints, shift scheduling, certification tracking, and plant-side workforce analytics.
      <br/><br/>
      <b>Stack:</b> React · Redux · Node.js · Express.js · MongoDB · Python · Redis · Firebase
    </td>
    <td width="33%" valign="top">
      <h3>🔐 On-Chain Identity Protocol</h3>
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
      <img src="https://img.shields.io/badge/Chain-Ethereum-purple?style=flat-square" />
      <br/><br/>
      Self-sovereign digital identity for DeFi — verifiable credentials, zero-knowledge proofs for selective disclosure, and wallet-native authentication. No PII stored on-chain.
      <br/><br/>
      <b>Stack:</b> Solidity · Circom · SnarkJS · IPFS · Ceramic Network · Next.js · Ethers.js
    </td>
    <td width="33%" valign="top">
      <h3>📊 AFTERMA Analytics</h3>
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
      <img src="https://img.shields.io/badge/Type-Dev_Tools-teal?style=flat-square" />
      <br/><br/>
      Advanced engagement analytics for developer products. AI-powered anomaly detection, cohort analysis, GitHub activity correlation, and AI recommendations for feature priorities.
      <br/><br/>
      <b>Stack:</b> Node.js · Redis · ClickHouse · Python · FastAPI · Next.js
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <h3>♻️ Carbon Credit Marketplace</h3>
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
      <img src="https://img.shields.io/badge/Sector-Climate_Tech-green?style=flat-square" />
      <br/><br/>
      Tokenized carbon credit trading for Indian industries. On-chain provenance for carbon offsets, smart contract marketplace, and integration with voluntary carbon standard registries.
      <br/><br/>
      <b>Stack:</b> Solidity · Next.js · The Graph · Node.js · MongoDB
    </td>
    <td width="33%" valign="top">
      <h3>⛓️ Steelchain</h3>
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
      <img src="https://img.shields.io/badge/Sector-Supply_Chain-gray?style=flat-square" />
      <br/><br/>
      Transparent on-chain supply chain provenance for steel products — raw material sourcing through finished goods, immutable audit trail for ESG compliance and export documentation.
      <br/><br/>
      <b>Stack:</b> Solidity · Node.js · MongoDB · Next.js · IPFS
    </td>
    <td width="33%" valign="top">
      <h3>🤖 AI Compliance Copilot</h3>
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
      <img src="https://img.shields.io/badge/Market-USA-blue?style=flat-square" />
      <br/><br/>
      LLM-powered compliance assistant for US fintech startups. Answers regulatory questions (BSA, FinCEN, CFPB), drafts compliance documents, and monitors regulatory change feeds.
      <br/><br/>
      <b>Stack:</b> Next.js · Node.js · LangChain · MongoDB · Redis · Python
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="33%" valign="top">
      <h3>☕ Caffenia</h3>
      <a href="https://caffenia.vercel.app/">
        <img src="https://img.shields.io/badge/Live-caffenia.vercel.app-black?style=flat-square&logo=vercel" />
      </a>
      <br/><br/>
      Modern e-commerce storefront with full cart management, Firebase authentication, product admin panel, and order processing pipeline.
      <br/><br/>
      <b>Stack:</b> React · Node.js · MongoDB · Firebase · Tailwind CSS
    </td>
    <td width="33%" valign="top">
      <h3>🌆 Smart City AI</h3>
      <img src="https://img.shields.io/badge/Status-In_Development-green?style=flat-square" />
      <br/><br/>
      AI APIs for sustainable urban mobility — traffic prediction, EV routing optimization, carbon footprint tracking, and logistics intelligence for Indian smart cities.
      <br/><br/>
      <b>Stack:</b> Next.js · MongoDB · Firebase · Python · TensorFlow Lite · Redis
    </td>
    <td width="33%" valign="top">
      <h3>👷 ASSAVA Job Platform</h3>
      <img src="https://img.shields.io/badge/Status-In_Development-green?style=flat-square" />
      <br/><br/>
      ML-based job-matching for the Indian steel industry workforce. Skill graph matching, shift scheduling, certification management, and plant-side workforce analytics.
      <br/><br/>
      <b>Stack:</b> React · Redux · Node.js · MongoDB · Python · Firebase
    </td>
  </tr>
</table>
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=ankitsharma706&theme=default&hide_border=true&show_icons=true" height="150"/>
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=ankitsharma706&theme=default&hide_border=true" height="150"/>
</div>

<div align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=ankitsharma706&theme=default&hide_border=true&layout=compact"/>
</div>
...
<table>
  <tr>
    <td width="33%" valign="top">
      <h4>aml-graph-toolkit</h4>
      Python library for building and analyzing financial transaction graphs. Includes common AML pattern detection utilities — structuring, layering, and smurfing detection built in.
      <br/><br/>
      <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" />
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
    </td>
    <td width="33%" valign="top">
      <h4>india-city-data</h4>
      Curated, normalized dataset of Indian city road networks, traffic zones, and administrative boundaries — formatted for routing and analytics applications.
      <br/><br/>
      <img src="https://img.shields.io/badge/Format-GeoJSON%2FCSV-green?style=flat-square" />
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
    </td>
    <td width="33%" valign="top">
      <h4>solidity-compliance-utils</h4>
      Solidity utility contracts for compliant DeFi — OFAC screening hooks, KYC registry integration, AML threshold enforcement, and SAR trigger events.
      <br/><br/>
  ...
  <tr>
    <td width="33%" valign="top">
      <h4>assava-job-taxonomy</h4>
      Machine-readable taxonomy of steel industry job roles, skills, and certifications formatted as a knowledge graph for matching and analytics.
      <br/><br/>
      <img src="https://img.shields.io/badge/Format-JSON_Graph-orange?style=flat-square" />
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
    </td>
    <td width="33%" valign="top">
      <h4>urban-flow-sdk</h4>
      TypeScript SDK for the Urban Flow API — traffic prediction, EV routing, and carbon footprint endpoints with typed responses and built-in retry logic.
      <br/><br/>
      <img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white" />
      <img src="https://img.shields.io/badge/Status-Planned-yellow?style=flat-square" />
    </td>
    <td width="33%" valign="top">
      <h4>defi-kyc-starter</h4>
      Boilerplate for building KYC-compliant DeFi frontends — wallet connect, identity verification flow, OFAC check, and compliance event logging out of the box.
      <br/><br/>
...
<table>
  <tr>
    <td width="33%" valign="top">
      <h4>🏦 Blockchain & US Fintech</h4>
      Building compliant DeFi products for US markets — what FinCEN, BSA, and OFAC regulations actually require and how to implement them at the architecture level.
    </td>
    <td width="33%" valign="top">
      <h4>🔗 Graph Algorithms in Production</h4>
      How flow network theory applies to real systems — traffic routing, workforce matching, and fraud detection using max-flow, bipartite matching, and GNNs.
    </td>
    <td width="33%" valign="top">
      <h4>🏙️ Smart City Infrastructure</h4>
      The gap between government smart city visions and engineering reality — sensor integration, traffic modeling, and APIs that plug into municipal systems.
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <h4>⚙️ High-Scale System Design</h4>
      Distributed systems trade-offs — sharding, caching strategies, event sourcing, and the CAP theorem applied to real product decisions.
    </td>
    <td width="33%" valign="top">
      <h4>🏭 Workforce Tech in Industry</h4>
      Why the steel industry's technology needs are fundamentally different from tech sector defaults — domain-specific ML, compliance constraints, and operational realities.
    </td>
    <td width="33%" valign="top">
      <h4>🔐 Web3 Identity & Privacy</h4>
...
> Technical blog coming soon. Follow on [X](https://x.com/ankit_sharma708) for updates.
...
|---|---|---|
| **LinkedIn** | [linkedin.com/in/ankitsharma706](https://www.linkedin.com/in/ankitsharma706/) | Professional network, collaboration requests |
| **X (Twitter)** | [x.com/ankit_sharma708](https://x.com/ankit_sharma708) | Tech thoughts, project updates, writing |
| **Email** | [ankitwhatsapps@gmail.com](mailto:ankitwhatsapps@gmail.com) | Direct outreach, collaborations |
| **Portfolio** | [caffenia.vercel.app](https://caffenia.vercel.app/) | Live project demo |
| **Buy Me a Coffee** | [buymeacoffee.com/ankitsharma7](https://buymeacoffee.com/ankitsharma7) | Support open source work |
...
*Open to collaborations · Building things that matter · Shipping code that works in production*

**If you read this far — let's build something.**
